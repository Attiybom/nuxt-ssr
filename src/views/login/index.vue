  ...
  <div class="login">
    ...
    <div class="right-part">
      <div class="login-container">
        ...
        <el-form label-width="80px" :label-position="'right'" ref="loginFormRef" :model="loginForm" :rules="loginRules" @submit.native.prevent="loginSubmit">
          <el-form-item prop="username" :label="t('login.username')">
            <el-input v-model="loginForm.username" autocomplete="off" :placeholder="t('login.placeMobile')" clearable ></el-input>
          </el-form-item>
          <el-form-item prop="password" :label="t('login.password')">
            <el-input type="password" v-model="loginForm.password" autocomplete="off" :placeholder="t('login.placePass')"  clearable ></el-input>
          </el-form-item>
          <el-form-item>
